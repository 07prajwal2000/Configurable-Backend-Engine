...
} from "@cbe/backend-engine/src/api/v1/app-config/get-all/dto";
import {
  requestBodySchema as createRequestBodySchema,
  responseSchema as createResponseSchema,
} from "@cbe/backend-engine/src/api/v1/app-config/create/dto";
import {
  requestBodySchema as updateRequestBodySchema,
  responseSchema as updateResponseSchema,
} from "@cbe/backend-engine/src/api/v1/app-config/update/dto";
import { responseSchema as getOneResponseSchema } from "@cbe/backend-engine/src/api/v1/app-config/get-by-id/dto";
import { httpClient } from "@/lib/http";
import {
  requestBodySchema as deleteBulkRequestBodySchema,
  responseSchema as deleteBulkResponseSchema,
} from "@cbe/backend-engine/src/api/v1/app-config/delete-bulk/dto";
